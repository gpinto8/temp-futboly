...
export const StandingsTab = () => {
  ...
  const breakpoint = useBreakpoint();
    ...
    let textForPastMatches = "There are matches that have not been calculated yet. ";
    textForPastMatches += leagueOwner === user.id ? "Go to Live Match and press Calculate Results" : "Ask the Admin to confirm and save to update the standings";
    useEffect(() => {
        (async () => {
  ...
  return (
    ...
    { pastMatchesNotCalculated() && (<p className="text-error-400 font-semibold mb-4">{textForPastMatches}</p>)}
