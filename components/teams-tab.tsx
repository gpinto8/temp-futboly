            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-4 auto-rows-fr">
                    {allTeams.map((team, index) => (
                        <CustomCard id={"team-card-"+index} key={index} style="gray" className={selectedTeam === index ? "row-span-2" : ""}>
                            <div className="flex flex-col justify-center items-start gap-2" onClick={() => selectedTeam === index ? setSelectedTeam(null) : setSelectedTeam(index)}>
                                ...
                                <button className="mt-4 px-4 py-2 bg-gray-200 rounded self-center shadow-md hover:scale-105 flex justify-center items-center gap-2">
                                    ...
                                    <CustomImage imageKey={selectedTeam === index ? "EXPAND" : "CLOSE_ICON"} className="h-4 w-4 ml-2"/>
                                </button>
                                {selectedTeam === index && (
